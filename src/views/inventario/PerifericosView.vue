                ...
                <div class="col-6 btn-group" v-if="dataPerfil.rol.id !== 4">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li v-if="dataPerfil.rol.id !== 3"><button class="dropdown-item" type="button" @click="fileData(rowData,'exportAll','perifericos')"><i class="bi bi-upload"></i> Exportar</button></li>
