...
<template>
  <div>
    ...
    <span class="badge fs-1"><i class="bi bi-box-seam"></i> Perífericos</span>
                ...
                <tr v-for="(row, index) in filteredAndPaginatedData" :key="index">
                  ...
                  <td>
                    ...
                    <ul class="dropdown-menu p-2 gap-3">
                      ...
                      <li v-if="dataPerfil.rol.id !== 3"><button class="btn btn-outline-warning text-red dropdown-item fs-5 p-0" title="Exportar" type="button" @click="fileData(row,'export','periferico' )"><i class="bi bi-upload"></i>Exportar</button></li>
