                ...
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-8">
                      ...
                      <textarea class="form-control" :class="{ 'is-invalid': paramsE.observacion && !/^[^<>{}\[\]]+$/.test(paramsE.observacion), 'is-valid':paramsE.observacion && /^[^<>{}\[\]]+$/.test(paramsE.observacion) }" placeholder="Observación" v-model="paramsE.observacion"></textarea>
                    </div>
